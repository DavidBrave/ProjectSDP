...
<body>
    ...
    <div id="content">
        ...
        <div id="col-kanan">
            <div style="width: 50%;">
                <h3>Update Data Jurusan</h3><br>
                ID: <input type="text" id="id" value="<?=$_SESSION['jurusan']['id']?>" disabled><br>
                Nama: <input type="text" id="nama" value="<?=$_SESSION['jurusan']['nama']?>"><br>
