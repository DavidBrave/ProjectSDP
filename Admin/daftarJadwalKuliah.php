...
<?php
    foreach ($list_jadwal as $key => $value) {
        ...
        echo "<td><form action='halamanUpdateJadwalKuliah.php' method='post'><button class='btn waves-effect waves-light' type='submit' name='btnUpdate' style='width: 150px;'>Update<i class='material-icons right'>edit</i></button><input type='hidden' name='hidId' value='$value[Jadwal_ID]'></form></td>";
