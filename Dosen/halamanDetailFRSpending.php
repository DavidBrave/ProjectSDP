<?php
    ...
    if(isset($_SESSION['detailFRSpending'])) {
        $id = $_SESSION['detailFRSpending'];
    ...
    if(isset($_POST['btnNext'])){
        $matkuls = "";
        for($i = 0 ; $i < sizeof($_POST['matkul'])-1 ; $i++) {
            $matkuls .= $_POST['matkul'][$i] . ",";
        }
        $matkuls .= $_POST['matkul'][sizeof($_POST['matkul'])-1];
        $_SESSION['matkul'] = $matkuls;
    ...
    <div id="col-kanan">
        ...
        <div id="container" style="padding: 20px;">
            ...
            <form action="#" method="post">
                ...
                <?php
                    ...
                    if($sksSemester1["Semester"]%2 != $semester%2){
                        ...
                        foreach ($semester1 as $key => $value) {
                            ...
                            if ($cek) {
                                echo "<td><p><label><input type='checkbox' class='matkul' name='matkul[]' value='$value[Matkul_Kurikulum_ID]' checked/><span></span></label></p></td>";
                            }
                            else {
                ...
                <button class="btn waves-effect grey lighten-1" style="width: 155px; height: 35px; padding-bottom: 2px; margin: 0px; float: right;" type="submit" id="btnNext" name="btnNext"><i class="material-icons right">navigate_next</i> Next</button>
            </form>
        </div>
        <div id="footer">
